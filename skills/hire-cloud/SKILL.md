---
name: hire-cloud
description: Contrata uma cloud (servidor) nova na Cloudez, paga ou de teste grátis. Use quando o usuário pedir para contratar, comprar, adicionar ou provisionar uma cloud/servidor novo fora do cadastro de conta — inclusive quando ele pedir uma cloud de teste, trial ou grátis numa conta que já existe.
---
...
eu contrato mais uma cloud", "quero contratar um cloud de teste" — cheguem ao
mesmo lugar que `/cloudez:hire-cloud`.
